...
//    private static final String IP = "10.0.2.2"; //localhost od PC za poganjanje iz emulatorja
    private static final String URL = "http://" + IP + "/client_seminar/mobile.php"; //pot do mobilne strani za telefone
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = (WebView) findViewById(R.id.webviewTable); //povemo kateri webview je izbran za prikaz
        ...
        webView.setWebViewClient(new WebViewClient(){
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl){
                ...
                Toast.makeText(MainActivity.this, "Error code is: " + errorCode, Toast.LENGTH_LONG).show();
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.chart:
                moveToChartActivity(); //premakne na drug activity
                break;
            case R.id.table:
